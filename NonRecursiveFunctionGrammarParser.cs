...
public sealed class NonRecursiveFunctionGrammarParser
{
    ...
    readonly Dictionary<string, string> _lexs = [];
    readonly List<Rule> _rules = [];
    readonly Dictionary<string, Rule> _rulesIndex = [];
    TreeNode? _gramTree;
    ...
    static void AddRuleToGramTree(TreeNode node, IEnumerable<string> ruleTerms, Rule rule)
    {
